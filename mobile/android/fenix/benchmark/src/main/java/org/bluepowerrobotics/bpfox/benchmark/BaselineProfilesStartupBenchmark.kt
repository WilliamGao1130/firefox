 ...
 *
 * ```
 * ./gradlew :benchmark:connectedBenchmarkAndroidTest -P android.testInstrumentationRunnerArguments.class=org.bluepowerrobotics.bpfox.benchmark.BaselineProfilesStartupBenchmark -P benchmarkTest
 * ```
 *
