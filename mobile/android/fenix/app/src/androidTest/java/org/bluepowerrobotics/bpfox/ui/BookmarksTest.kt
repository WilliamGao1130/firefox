...
import org.bluepowerrobotics.bpfox.helpers.MockBrowserDataHelper.generateBookmarkFolder
...
class BookmarksTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BookmarksTest#deleteBookmarkFoldersTest"],
        bug = 2043198,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BookmarksTest#editBookmarksNameAndUrlTest"],
        bug = 2024690,
        since = "2026-03",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BookmarksTest#shareBookmarkTest"],
        bug = 2043198,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BookmarksTest#openMultipleSelectedBookmarksInANewTabTest"],
        bug = 2043198,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BookmarksTest#deleteMultipleSelectedBookmarksTest"],
        bug = 2043198,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BookmarksTest#verifySearchForBookmarkedItemsTest"],
        bug = 2043198,
        since = "2026-05",
    )
    @SmokeTest
