...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.setScreenOrientation
...
import org.bluepowerrobotics.bpfox.ui.robots.composeBookmarksMenu
...
class NavigationToolbarExpandedTest {
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheExpandedToolbarAddBookmarkButtonTest"
            ],
        bug = 2060480,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheExpandedToolbarShareButtonTest"
            ],
        bug = 2060480,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.ToolbarTest#verifyTheExpandedToolbarNewTabButtonTest"],
        bug = 2057957,
        since = "2026-07",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.ToolbarTest#verifyTheExpandedToolbarTabTrayButtonTest"],
        bug = 2057419,
        since = "2026-07",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.ToolbarTest#verifyTheExpandedToolbarMainMenuButtonTest"],
        bug = 2057419,
        since = "2026-07",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheExpandedToolbarItemsInLandscapeModeTest"
            ],
        bug = 2060480,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheExpandedToolbarNewTabButtonInLandscapeModeTest"
            ],
        bug = 2060480,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheExpandedToolbarTabTrayButtonInLandscapeModeTest"
            ],
        bug = 2060480,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheExpandedToolbarMainMenuButtonInLandscapeModeTest"
            ],
        bug = 2060480,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyHomepageItemsWithTabStripTest"],
        bug = 2060482,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheTabStripUITest"],
        bug = 2060482,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTheNewTabButtonWithTabStripEnabledTest"
            ],
        bug = 2060482,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.NavigationToolbarExpandedTest#verifyTabsTrayWithTabStripEnabledTest"
            ],
        bug = 2060482,
        since = "2026-08",
    )
