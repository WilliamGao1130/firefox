...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.enhancedTrackingProtectionAsset
...
class UnifiedTrustPanelTest {
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.UnifiedTrustPanelTest#verifySecurePageConnectionFromQuickSettingsWithNoTrackersTest"
            ],
        bug = 2057420,
        since = "2026-07",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.UnifiedTrustPanelTest#verifyInsecurePageConnectionFromQuickSettingsWithTrackersTest"
            ],
        bug = 2057420,
        since = "2026-07",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.UnifiedTrustPanelTest#verifyClearCookiesAndSiteDataFromQuickSettingsTest"
            ],
        bug = 2040857,
        since = "2026-06",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.UnifiedTrustPanelTest#verifyInsecurePageConnectionFromQuickSettingsWithNoTrackersInCustomTabsTest"
            ],
        bug = 2057413,
        since = "2026-07",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.UnifiedTrustPanelTest#verifyClearCookiesAndSiteDataFromQuickSettingsInCustomTabsTest"
            ],
        bug = 2057421,
        since = "2026-07",
    )
