...
class GradlewBuild:
    ...
    def test(self, identifier):
        ...
        cmd = (
            "./gradlew "
            + f"app:connectedDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=org.bluepowerrobotics.bpfox.syncintegration.SyncIntegrationTest#{identifier}"
        )
