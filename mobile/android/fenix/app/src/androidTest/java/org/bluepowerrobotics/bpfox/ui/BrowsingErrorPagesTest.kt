...
class BrowsingErrorPagesTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BrowsingErrorPagesTest#verifyMalwareWebsiteWarningMessageTest"],
        bug = 2045673,
        since = "2026-06",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BrowsingErrorPagesTest#verifyPhishingWebsiteWarningMessageTest"],
        bug = 2045673,
        since = "2026-06",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.BrowsingErrorPagesTest#verifyUnwantedSoftwareWebsiteWarningMessageTest"
            ],
        bug = 2045673,
        since = "2026-06",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.BrowsingErrorPagesTest#verifyHarmfulWebsiteWarningMessageTest"],
        bug = 2045673,
        since = "2026-06",
    )
    @SmokeTest
