...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.addressFormAsset
...
import org.bluepowerrobotics.bpfox.ui.robots.autofillScreen
...
class AddressAutofillTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.AddressAutofillTest#verifyAddressAutofillTest"],
        bug = 2057958,
        since = "2026-07",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.AddressAutofillTest#deleteSavedAddressTest"],
        bug = 2060174,
        since = "2026-08",
    )
    @SmokeTest
