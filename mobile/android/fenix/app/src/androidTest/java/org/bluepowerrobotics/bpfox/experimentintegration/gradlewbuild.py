...
class GradlewBuild:
    ...
    def test(self, identifier, smoke=None):
        ...
        cmd = f"adb shell am instrument -w -e class org.bluepowerrobotics.bpfox.{test_type}.{identifier} -e EXP_NAME '{os.getenv('EXP_NAME', '').replace('(', '').replace(')', '')}' org.bluepowerrobotics.bpfox.debug.test/androidx.test.runner.AndroidJUnitRunner"
