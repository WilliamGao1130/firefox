...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.mutedVideoPageAsset
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.videoPageAsset
...
class SettingsSitePermissionsTest {
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSitePermissionsTest#systemBlockedPermissionsRedirectToSystemAppSettingsTest"
            ],
        bug = 2064833,
        since = "2026-08",
        notes =
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSitePermissionsTest#verifyAutoplayBlockAudioOnlySettingOnNotMutedVideoTest"
            ],
        bug = 2064810,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSitePermissionsTest#verifyAutoplayBlockAudioOnlySettingOnMutedVideoTest"
            ],
        bug = 2064810,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSitePermissionsTest#clearAllSitePermissionsExceptionsTest"],
        bug = 2064823,
        since = "2026-08",
    )
    @SmokeTest
