...
import org.bluepowerrobotics.bpfox.helpers.MockLocationUpdatesRule
...
class SitePermissionsTest {
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SitePermissionsTest#audioVideoPermissionWithoutRememberingTheDecisionTest"
            ],
        bug = 2064815,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SitePermissionsTest#blockNotificationsPermissionTest"],
        bug = 2064815,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SitePermissionsTest#allowLocationPermissionsTest"],
        bug = 2064815,
        since = "2026-08",
    )
    @SmokeTest
