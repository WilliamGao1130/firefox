...
import org.bluepowerrobotics.bpfox.ui.robots.collectionRobot
import org.bluepowerrobotics.bpfox.ui.robots.composeTabDrawer
...
class CollectionTest {
    ...
    @Test
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.CollectionsTest#verifyExpandedCollectionItemsTest"],
        bug = 2054023,
        since = "2026-07",
    )
    ...
    @Test
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.CollectionsTest#openAllTabsFromACollectionTest"],
        bug = 2054023,
        since = "2026-07",
    )
    ...
    @Test
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.CollectionsTest#shareAllTabsFromACollectionTest"],
        bug = 2054023,
        since = "2026-07",
    )
    ...
    @Test
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.CollectionsTest#deleteCollectionTest"],
        bug = 2054023,
        since = "2026-07",
    )
