...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.saveLoginAsset
...
import org.bluepowerrobotics.bpfox.ui.robots.setPageObjectText
...
class LoginsTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.LoginsTest#verifyUpdatedLoginIsSavedTest"],
        bug = 2060474,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.LoginsTest#verifyMultipleLoginsSelectionsTest"],
        bug = 2060474,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsPasswordsTest#verifyNeverSaveLoginOptionTest"],
        bug = 2057407,
        since = "2026-07",
    )
    @SmokeTest
