...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.storageCheckPageAsset
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.storageWritePageAsset
...
class SettingsDeleteBrowsingDataOnQuitTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsDeleteBrowsingDataOnQuitTest#deleteDownloadsOnQuitTest"],
        bug = 2040277,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsDeleteBrowsingDataOnQuitTest#deleteSitePermissionsOnQuitTest"
            ],
        bug = 2040277,
        since = "2026-05",
    )
