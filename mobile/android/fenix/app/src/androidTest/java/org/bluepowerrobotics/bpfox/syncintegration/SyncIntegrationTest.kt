...
package org.bluepowerrobotics.bpfox.syncintegration
...
import org.bluepowerrobotics.bpfox.ui.robots.accountSettings
import org.bluepowerrobotics.bpfox.ui.robots.homeScreen
import org.bluepowerrobotics.bpfox.ui.robots.settingsSubMenuLoginsAndPassword
...
class SyncIntegrationTest {
    ...
    fun syncHistoryBetweenMobileAndDesktopTest() {
        ...
        TestHelper.mDevice.waitNotNull(Until.findObjects(By.res("org.bluepowerrobotics.bpfox.debug:id/counter_root")))
    ...
    fun tapReturnToPreviousApp() {
        ...
        TestHelper.mDevice.waitNotNull(Until.findObjects(By.text("Account")), TestAssetHelper.waitingTime)
        TestHelper.mDevice.waitNotNull(
            Until.findObjects(By.res("org.bluepowerrobotics.bpfox.debug:id/email")),
            TestAssetHelper.waitingTime,
        )
        TestAssetHelper.waitingTime
        // Go to Homescreen
