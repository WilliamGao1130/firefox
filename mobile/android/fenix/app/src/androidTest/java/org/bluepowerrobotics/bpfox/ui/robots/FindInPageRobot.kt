...
class FindInPageRobot {
    ...
    fun enterFindInPageQuery(expectedText: String) {
        mDevice.waitNotNull(Until.findObject(By.res("org.bluepowerrobotics.bpfox.debug:id/find_in_page_query_text")), waitingTime)
        ...
        mDevice.waitNotNull(Until.gone(By.res("org.bluepowerrobotics.bpfox.debug:id/find_in_page_result_text")), waitingTime)
        ...
        mDevice.waitNotNull(
            Until.findObject(By.res("org.bluepowerrobotics.bpfox.debug:id/find_in_page_result_text")),
            waitingTime,
        )
    }
