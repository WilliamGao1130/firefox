...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.runWithAppLocaleChanged
import org.bluepowerrobotics.bpfox.helpers.DataGenerationHelper.setTextToClipBoard
...
import org.bluepowerrobotics.bpfox.helpers.MockBrowserDataHelper.addCustomSearchEngine
import org.bluepowerrobotics.bpfox.helpers.MockBrowserDataHelper.createBookmarkItem
import org.bluepowerrobotics.bpfox.helpers.MockBrowserDataHelper.createHistoryItem
...
import org.bluepowerrobotics.bpfox.ui.robots.EngineShortcut
...
class SettingsSearchTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSearchTest#verifyTheDefaultSearchEngineCanBeChangedTest"],
        bug = 2041713,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSearchTest#verifyCustomSearchEngineCanBeAddedFromSearchEngineMenuTest"
            ],
        bug = 2062943,
        since = "2026-08",
        notes =
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSearchTest#verifyShowSearchSuggestionsToggleTest"],
        bug = 2062943,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsSearchTest#verifySearchShortcutChangesAreReflectedInSearchSelectorMenuTest"
            ],
        bug = 2062943,
        since = "2026-08",
    )
