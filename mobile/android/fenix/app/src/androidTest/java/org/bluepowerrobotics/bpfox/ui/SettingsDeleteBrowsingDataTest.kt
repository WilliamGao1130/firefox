...
class SettingsDeleteBrowsingDataTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsDeleteBrowsingDataTest#deleteOpenTabsBrowsingDataTest"],
        bug = 2062279,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsDeleteBrowsingDataTest#deleteBrowsingHistoryTest"],
        bug = 2062279,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsDeleteBrowsingDataTest#deleteCookiesAndSiteDataTest"],
        bug = 2062279,
        since = "2026-08",
    )
    @SmokeTest
