...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.denyPermission
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.denyPermissionAndDontAskAgainButton
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.grantSystemPermission
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.verifyKeyboardVisibility
...
import org.bluepowerrobotics.bpfox.helpers.MockBrowserDataHelper.createTabItem
import org.bluepowerrobotics.bpfox.helpers.MockBrowserDataHelper.setCustomSearchEngine
...
import org.bluepowerrobotics.bpfox.helpers.TestHelper.longTapSelectItem
...
import org.bluepowerrobotics.bpfox.ui.robots.clickContextMenuItem
import org.bluepowerrobotics.bpfox.ui.robots.clickPageObject
import org.bluepowerrobotics.bpfox.ui.robots.homeScreen
import org.bluepowerrobotics.bpfox.ui.robots.longClickPageObject
import org.bluepowerrobotics.bpfox.ui.robots.multipleSelectionToolbar
import org.bluepowerrobotics.bpfox.ui.robots.navigationToolbar
import org.bluepowerrobotics.bpfox.ui.robots.searchScreen
import org.bluepowerrobotics.bpfox.ui.robots.settingsTurnOnSyncScreen
...
class SearchTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#verifyQRScanningCameraAccessDialogTest"],
        bug = 2063102,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#scanQRCodeToOpenAWebpageTest"],
        bug = 2063052,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#searchEnginesCanBeChangedTemporarilyFromSearchSelectorMenuTest"
            ],
        bug = 2063045,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#searchResultsOpenedInNewTabsGenerateSearchGroupsTest"],
        bug = 2063072,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#searchGroupIsNotGeneratedForLinksOpenedInPrivateTabsTest"
            ],
        bug = 2063074,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#deleteIndividualHistoryItemsFromSearchGroupTest"],
        bug = 2063080,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#verifyHistorySearchWithBrowsingHistoryTest"],
        bug = 2063046,
        since = "2026-08",
        notes =
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#verifyTabsSearchWithOpenTabsTest"],
        bug = 2063043,
        since = "2026-08",
        notes =
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SearchTest#searchHistoryNotRememberedInPrivateBrowsingTest"],
        bug = 2063066,
        since = "2026-08",
    )
    @SmokeTest
