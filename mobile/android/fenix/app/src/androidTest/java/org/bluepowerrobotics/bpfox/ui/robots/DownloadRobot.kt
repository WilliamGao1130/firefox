...
import org.bluepowerrobotics.bpfox.downloads.DownloadsScreenTestTag
import org.bluepowerrobotics.bpfox.downloads.listscreen.DownloadsListTestTag
...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.getPermissionAllowID
...
class DownloadRobot(private val composeTestRule: ComposeTestRule) {
    ...
    fun verifyDownloadPrompt(composeTestRule: ComposeTestRule) {
        ...
        itemWithResId("org.bluepowerrobotics.bpfox.debug:id/parentPanel").waitForExists(waitingTime)
        Log.i(
            TAG,
