...
import org.bluepowerrobotics.bpfox.ui.robots.historyMenu
...
class HistoryTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.HistoryTest#verifyHistoryMenuWithHistoryItemsTest"],
        bug = 2039573,
        since = "2026-05",
    )
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.HistoryTest#deleteAllHistoryTest"],
        bug = 2039573,
        since = "2026-05",
    )
    @SmokeTest
    ...
    // caution when making changes to it, so they don't block the builds
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.HistoryTest#noHistoryInPrivateBrowsingTest"],
        bug = 2024690,
        since = "2026-03",
    )
    @SmokeTest
