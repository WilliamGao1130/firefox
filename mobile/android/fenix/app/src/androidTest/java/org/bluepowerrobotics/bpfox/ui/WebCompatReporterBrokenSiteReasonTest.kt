...
import org.bluepowerrobotics.bpfox.webcompat.ui.WebCompatReporter
...
class WebCompatReporterBrokenSiteReasonTest {
    ...
    fun optionalFieldsVisibleOnlyWhenReasonSelectedTest() {
        ...
        val clearIconDescription =
            context.getString(org.bluepowerrobotics.bpfox.R.string.webcompat_reporter_clear_reason_content_description)
