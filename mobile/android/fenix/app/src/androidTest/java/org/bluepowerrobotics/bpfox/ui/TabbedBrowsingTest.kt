...
class TabbedBrowsingTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TabbedBrowsingTest#verifyCloseAllPrivateTabsNotificationTest"],
        bug = 2063303,
        since = "2026-08",
        notes =
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TabbedBrowsingTest#verifyPrivateTabsTrayWithOpenTabTest"],
        bug = 2043491,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TabbedBrowsingTest#verifySyncedTabsWhenUserIsNotSignedInTest"],
        bug = 2039245,
        since = "2026-05",
    )
    @Test
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TabbedBrowsingTest#shareTabsFromTabsTrayTest"],
        bug = 2063303,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TabbedBrowsingTest#privateTabsDoNotPersistAfterClosingAppTest"],
        bug = 2058121,
        since = "2026-07",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TabbedBrowsingTest#verifyTheSearchTabsFunctionalityTest"],
        bug = 2063303,
        since = "2026-08",
    )
    @SmokeTest
