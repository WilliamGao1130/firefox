...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.disableWifiNetworkConnection
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.enableDataSaverSystemSetting
...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.secondForeignWebPageAsset
...
import org.bluepowerrobotics.bpfox.ui.robots.translationsRobot
...
class TranslationsTest {
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.TranslationsTest#verifyTheFirstTranslationNotNowButtonFunctionalityTest"
            ],
        bug = 2059397,
        since = "2026-07",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TranslationsTest#verifyMainMenuTranslationButtonFunctionalityTest"],
        bug = 2060217,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TranslationsTest#verifyTheDownloadLanguagesFunctionalityTest"],
        bug = 2063223,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @SmokeTest
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TranslationsTest#verifyTheNeverTranslateOptionTest"],
        bug = 2063228,
        since = "2026-08",
    )
    @Test
