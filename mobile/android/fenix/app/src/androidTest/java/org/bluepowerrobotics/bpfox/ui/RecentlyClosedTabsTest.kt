...
class RecentlyClosedTabsTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.RecentlyClosedTabsTest#openRecentlyClosedItemTest"],
        bug = 2057411,
        since = "2026-07",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.RecentlyClosedTabsTest#deleteRecentlyClosedTabsItemTest"],
        bug = 2057411,
        since = "2026-07",
    )
    @SmokeTest
