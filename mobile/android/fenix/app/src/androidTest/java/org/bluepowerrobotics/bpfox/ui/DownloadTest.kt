...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.deleteDownloadedFileOnStorage
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.setNetworkEnabled
import org.bluepowerrobotics.bpfox.helpers.Constants.PackageName.GMAIL_APP
import org.bluepowerrobotics.bpfox.helpers.Constants.PackageName.GOOGLE_APPS_PHOTOS
...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.downloadPageAsset
...
import org.bluepowerrobotics.bpfox.ui.robots.downloadRobot
import org.bluepowerrobotics.bpfox.ui.robots.homeScreen
import org.bluepowerrobotics.bpfox.ui.robots.navigationToolbar
import org.bluepowerrobotics.bpfox.ui.robots.notificationShade
...
class DownloadTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.DownloadTest#pauseResumeCancelDownloadTest"],
        bug = 2063195,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.DownloadTest#saveAsPdfFunctionalityTest"],
        bug = 2060299,
        since = "2026-08",
        notes =
