...
class TextSelectionTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TextSelectionTest#verifySelectAllTextOptionTest"],
        bug = 2063396,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TextSelectionTest#verifyPrivateSearchTextTest"],
        bug = 2063396,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TextSelectionTest#verifyCopyPDFTextOptionTest"],
        bug = 2063396,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.TextSelectionTest#verifySearchPDFTextOptionTest"],
        bug = 2063396,
        since = "2026-08",
    )
    @SmokeTest
