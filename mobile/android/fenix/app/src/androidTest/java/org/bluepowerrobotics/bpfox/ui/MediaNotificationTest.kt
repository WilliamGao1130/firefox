...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.audioPageAsset
...
class MediaNotificationTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.MediaNotificationTest#verifyVideoPlaybackSystemNotificationTest"],
        bug = 2063242,
        since = "2026-08",
    )
    @SmokeTest
