...
import org.bluepowerrobotics.bpfox.helpers.OpenLinksInApp
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.appLinksRedirectAsset
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.externalLinksAsset
...
class SettingsAdvancedTest {
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsOpenLinksInAppsTest#askBeforeOpeningOpenLinkInAppTest"],
        bug = 2061722,
        since = "2026-08",
        notes =
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsOpenLinksInAppsTest#askBeforeOpeningLinkInAppCancelTest"],
        bug = 2061722,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsOpenLinksInAppsTest#askBeforeOpeningLinkInAppOpenTest"],
        bug = 2061722,
        since = "2026-08",
    )
    @SmokeTest
