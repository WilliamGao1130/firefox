...
import org.bluepowerrobotics.bpfox.helpers.Constants.defaultTopSitesList
import org.bluepowerrobotics.bpfox.helpers.DataGenerationHelper.generateRandomString
...
class TopSitesTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.ShortcutsTest#addAWebsiteAsATopSiteTest"],
        bug = 2048243,
        since = "2026-06",
    )
    @SmokeTest
