...
import org.bluepowerrobotics.bpfox.helpers.TestHelper.verifyDarkThemeApplied
import org.bluepowerrobotics.bpfox.helpers.TestHelper.verifyLightThemeApplied
...
class SettingsCustomizeTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsCustomizeTest#verifyTheDefaultAppIconSettingTest"],
        bug = 2039839,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsCustomizeTest#verifyTheAppIconSelectionPageTest"],
        bug = 2040906,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsCustomizeTest#verifyTheChangeAppIconButtonTest"],
        bug = 2040906,
        since = "2026-05",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsCustomizeTest#verifyTheToolbarLayoutSectionTest"],
        bug = 2040906,
        since = "2026-05",
    )
    @Test
