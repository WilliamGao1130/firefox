...
import org.bluepowerrobotics.bpfox.ui.robots.addonsMenu
...
class SettingsAddonsTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsAddonsTest#noCrashWithAddonInstalledTest"],
        bug = 2062856,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.SettingsAddonsTest#verifyUBlockWorksInPrivateModeTest"],
        bug = 2062856,
        since = "2026-08",
    )
    @SmokeTest
