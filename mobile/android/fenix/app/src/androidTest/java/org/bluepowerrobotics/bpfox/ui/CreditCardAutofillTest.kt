...
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.bringAppToForeground
import org.bluepowerrobotics.bpfox.helpers.AppAndSystemHelper.putAppToBackground
...
import org.bluepowerrobotics.bpfox.helpers.TestAssetHelper.creditCardFormAsset
...
class CreditCardAutofillTest {
    ...
    @Converted(
        replacedBy = ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.CreditCardAutofillTest#verifyCreditCardAutofillTest"],
        bug = 2063262,
        since = "2026-08",
    )
    @SmokeTest
    ...
    @Converted(
        replacedBy =
            [
                "org.bluepowerrobotics.bpfox.ui.efficiency.tests.CreditCardAutofillTest#deleteSavedCreditCardUsingToolbarButtonTest"
            ],
        bug = 2063262,
        since = "2026-08",
    )
    ...
    @Converted(
        replacedBy =
            ["org.bluepowerrobotics.bpfox.ui.efficiency.tests.CreditCardAutofillTest#deleteSavedCreditCardUsingMenuButtonTest"],
        bug = 2060406,
        since = "2026-08",
    )
    @SmokeTest
