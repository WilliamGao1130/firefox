...
import org.bluepowerrobotics.bpfox.components.fake.FakeMetricController
...
import org.bluepowerrobotics.bpfox.distributions.DistributionProviderChecker
import org.bluepowerrobotics.bpfox.distributions.DistributionSettings
...
class FenixApplicationTest {
    ...
    fun `WHEN setStartupMetrics is called THEN sets some base metrics`() = runBlocking {
        val expectedAppName = "org.bluepowerrobotics.bpfox"
