...
import org.bluepowerrobotics.bpfox.settings.toggle
import org.bluepowerrobotics.bpfox.settings.trustpanel.store.AutoplayValue
...
import org.bluepowerrobotics.bpfox.settings.trustpanel.store.WebsitePermissionsState
...
class TrustPanelMiddleware(
    ...
    private fun WebsitePermissionsState.getAutoplayValue() =
        (this[org.bluepowerrobotics.bpfox.settings.PhoneFeature.AUTOPLAY] as? WebsitePermission.Autoplay)?.autoplayValue
}
