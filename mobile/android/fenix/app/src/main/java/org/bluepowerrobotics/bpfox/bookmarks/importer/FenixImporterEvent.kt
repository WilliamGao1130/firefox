...
package org.bluepowerrobotics.bpfox.bookmarks.importer

/**
 * Fenix equivalent of [mozilla.components.feature.importer.ImporterEvent]
 *
 * This is needed because we are sending the result from [org.bluepowerrobotics.bpfox.bookmarks.ImportBookmarksDialogFragment] to
 * [org.bluepowerrobotics.bpfox.bookmarks.BookmarkFragment] through bundles, and we need a simplified result object that is easily
