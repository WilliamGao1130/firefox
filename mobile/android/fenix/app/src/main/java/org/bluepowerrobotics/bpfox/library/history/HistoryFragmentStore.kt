...
sealed class HistoryFragmentAction : Action {
    ...
    /** Updates the empty state of [org.bluepowerrobotics.bpfox.library.history.HistoryView]. */
    data class ChangeEmptyState(val isEmpty: Boolean) : HistoryFragmentAction()

    /**
     * Updates the set of items marked for removal from the [org.bluepowerrobotics.bpfox.components.AppStore] to the
