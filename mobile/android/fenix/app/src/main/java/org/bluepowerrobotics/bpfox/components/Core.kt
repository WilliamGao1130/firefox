...
import org.bluepowerrobotics.bpfox.AppRequestInterceptor
...
import org.bluepowerrobotics.bpfox.ReleaseChannel
import org.bluepowerrobotics.bpfox.browser.desktopmode.DefaultDesktopModeRepository
import org.bluepowerrobotics.bpfox.browser.desktopmode.DesktopModeMiddleware
import org.bluepowerrobotics.bpfox.components.search.ApplicationSearchMiddleware
import org.bluepowerrobotics.bpfox.components.search.SearchMigration
import org.bluepowerrobotics.bpfox.components.search.SearchWidgetMiddleware
import org.bluepowerrobotics.bpfox.downloads.DownloadService
import org.bluepowerrobotics.bpfox.ext.components
import org.bluepowerrobotics.bpfox.ext.isLargeWindow
import org.bluepowerrobotics.bpfox.gecko.GeckoProvider
import org.bluepowerrobotics.bpfox.historymetadata.DefaultHistoryMetadataService
import org.bluepowerrobotics.bpfox.historymetadata.HistoryMetadataMiddleware
import org.bluepowerrobotics.bpfox.historymetadata.HistoryMetadataService
import org.bluepowerrobotics.bpfox.longfox.LongFoxFeature
import org.bluepowerrobotics.bpfox.media.MediaSessionService
...
import org.bluepowerrobotics.bpfox.settings.advanced.getSelectedLocale
import org.bluepowerrobotics.bpfox.settings.downloads.DownloadLocationManager
import org.bluepowerrobotics.bpfox.share.DefaultSentFromFirefoxManager
import org.bluepowerrobotics.bpfox.share.DefaultSentFromStorage
import org.bluepowerrobotics.bpfox.share.SaveToPDFMiddleware
import org.bluepowerrobotics.bpfox.summarization.FenixSummarizationSettingsBinding
import org.bluepowerrobotics.bpfox.summarization.eligibility.DefaultSummarizationEligibilityChecker
import org.bluepowerrobotics.bpfox.summarization.eligibility.SummarizationEligibilityChecker
import org.bluepowerrobotics.bpfox.summarization.onboarding.FenixSummarizationFeatureConfiguration
import org.bluepowerrobotics.bpfox.summarization.onboarding.SummarizationFeatureDiscoveryConfiguration
import org.bluepowerrobotics.bpfox.tabgroups.storage.redux.middleware.TabGroupMiddleware
import org.bluepowerrobotics.bpfox.tabgroups.storage.repository.DefaultTabGroupRepository
import org.bluepowerrobotics.bpfox.telemetry.TelemetryMiddleware
...
class Core(
    ...
    /**
     * Fenix implementation of [SummarizationFeatureDiscoveryConfiguration] backed by [org.bluepowerrobotics.bpfox.utils.Settings]
     */
