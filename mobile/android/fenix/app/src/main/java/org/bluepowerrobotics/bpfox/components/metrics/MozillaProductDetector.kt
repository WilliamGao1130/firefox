...
object MozillaProductDetector {
    enum class MozillaProducts(val productName: String) {
        // Browsers
        FIREFOX("org.bluepowerrobotics.bpfox"),
        FIREFOX_NIGHTLY("org.mozilla.fennec_aurora"),
        FIREFOX_BETA("org.bluepowerrobotics.bpfox"),
        ...
        FENIX("org.bluepowerrobotics.bpfox"),
        FENIX_NIGHTLY("org.bluepowerrobotics.bpfox.nightly"),
