...
import org.bluepowerrobotics.bpfox.GleanMetrics.AppIcon
import org.bluepowerrobotics.bpfox.GleanMetrics.Events
import org.bluepowerrobotics.bpfox.GleanMetrics.Metrics
import org.bluepowerrobotics.bpfox.GleanMetrics.NativeShareSheet
import org.bluepowerrobotics.bpfox.GleanMetrics.SplashScreen
import org.bluepowerrobotics.bpfox.GleanMetrics.StartOnHome
import org.bluepowerrobotics.bpfox.GleanMetrics.SyncAccount
import org.bluepowerrobotics.bpfox.addons.ExtensionsProcessDisabledBackgroundController
import org.bluepowerrobotics.bpfox.addons.ExtensionsProcessDisabledForegroundController
import org.bluepowerrobotics.bpfox.automation.AutomatedLaunch
import org.bluepowerrobotics.bpfox.bindings.ExternalAppLinkStatusBinding
import org.bluepowerrobotics.bpfox.bindings.HomepageTabBinding
import org.bluepowerrobotics.bpfox.bindings.SummarizeToolbarHighlightBinding
import org.bluepowerrobotics.bpfox.bookmarks.DesktopFolders
import org.bluepowerrobotics.bpfox.browser.BrowserFragment
...
import org.bluepowerrobotics.bpfox.browser.browsingmode.DefaultBrowsingModeManager
import org.bluepowerrobotics.bpfox.components.DefaultHomepageAsANewTabPreferenceRepository
...
import org.bluepowerrobotics.bpfox.components.appstate.AppAction.ShareAction
import org.bluepowerrobotics.bpfox.components.appstate.OrientationMode
import org.bluepowerrobotics.bpfox.components.ipprotection.ErrorMessages
import org.bluepowerrobotics.bpfox.components.ipprotection.IPProtectionInfoPrompter
import org.bluepowerrobotics.bpfox.components.menu.MenuAccessPoint
import org.bluepowerrobotics.bpfox.components.menu.share.QRCodeDialogFragment
import org.bluepowerrobotics.bpfox.components.metrics.BreadcrumbsRecorder
import org.bluepowerrobotics.bpfox.components.metrics.GrowthDataWorker
import org.bluepowerrobotics.bpfox.components.metrics.InstallReferrerHandlingService
import org.bluepowerrobotics.bpfox.components.metrics.fonts.FontEnumerationWorker
import org.bluepowerrobotics.bpfox.components.share.QR_CODE_URI_KEY
import org.bluepowerrobotics.bpfox.components.share.SEND_TO_DEVICES_ACTION
import org.bluepowerrobotics.bpfox.components.share.SendToDevicesDialogFragment
import org.bluepowerrobotics.bpfox.crashes.CrashActionDispatcher
import org.bluepowerrobotics.bpfox.crashes.CrashReporterBinding
import org.bluepowerrobotics.bpfox.crashes.UnsubmittedCrashDialog
import org.bluepowerrobotics.bpfox.customtabs.ExternalAppBrowserActivity
import org.bluepowerrobotics.bpfox.databinding.ActivityHomeBinding
import org.bluepowerrobotics.bpfox.debugsettings.data.DefaultDebugSettingsRepository
import org.bluepowerrobotics.bpfox.debugsettings.gleandebugtools.DefaultGleanDebugToolsStorage
import org.bluepowerrobotics.bpfox.debugsettings.ui.FenixOverlay
import org.bluepowerrobotics.bpfox.downloads.DownloadSnackbar
import org.bluepowerrobotics.bpfox.e2e.EdgeToEdgeFragmentLifecycleCallbacks
import org.bluepowerrobotics.bpfox.experiments.ResearchSurfaceDialogFragment
import org.bluepowerrobotics.bpfox.experiments.UninstallSurveyManager
import org.bluepowerrobotics.bpfox.ext.alreadyOnDestination
import org.bluepowerrobotics.bpfox.ext.breadcrumb
import org.bluepowerrobotics.bpfox.ext.components
import org.bluepowerrobotics.bpfox.ext.getBreadcrumbMessage
import org.bluepowerrobotics.bpfox.ext.getIntentSessionId
import org.bluepowerrobotics.bpfox.ext.getIntentSource
import org.bluepowerrobotics.bpfox.ext.getNavDirections
import org.bluepowerrobotics.bpfox.ext.hasTopDestination
import org.bluepowerrobotics.bpfox.ext.isAllowedDuringOnboardingIntent
import org.bluepowerrobotics.bpfox.ext.nav
import org.bluepowerrobotics.bpfox.ext.openSetDefaultBrowserOption
import org.bluepowerrobotics.bpfox.ext.recordEventInNimbus
import org.bluepowerrobotics.bpfox.ext.setNavigationIcon
import org.bluepowerrobotics.bpfox.extension.WebExtensionPromptFeature
import org.bluepowerrobotics.bpfox.home.HomeFragment
import org.bluepowerrobotics.bpfox.home.TopSitesRefresher
import org.bluepowerrobotics.bpfox.home.intent.AssistIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.CrashReporterIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.HomeDeepLinkIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.LensResultIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.OpenBrowserIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.OpenPasswordManagerIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.OpenRecentlyClosedIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.OpenSpecificTabIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.SpeechProcessingIntentProcessor
import org.bluepowerrobotics.bpfox.home.intent.StartSearchIntentProcessor
import org.bluepowerrobotics.bpfox.home.topsites.DefaultTopSitesBinding
import org.bluepowerrobotics.bpfox.messaging.FenixMessageSurfaceId
import org.bluepowerrobotics.bpfox.messaging.MessageNotificationWorker
import org.bluepowerrobotics.bpfox.nimbus.FxNimbus
import org.bluepowerrobotics.bpfox.onboarding.ensureMarketingChannelExists
import org.bluepowerrobotics.bpfox.onboarding.seedOnboardingCompletedTimestampForDebugIfNeeded
import org.bluepowerrobotics.bpfox.pbmlock.DefaultPrivateBrowsingLockStorage
import org.bluepowerrobotics.bpfox.pbmlock.PrivateBrowsingLockFeature
import org.bluepowerrobotics.bpfox.perf.DefaultStartupPathProvider
import org.bluepowerrobotics.bpfox.perf.MarkersActivityLifecycleCallbacks
import org.bluepowerrobotics.bpfox.perf.MarkersFragmentLifecycleCallbacks
import org.bluepowerrobotics.bpfox.perf.PerformanceInflater
import org.bluepowerrobotics.bpfox.perf.ProfilerMarkers
import org.bluepowerrobotics.bpfox.perf.StartupPathProvider
import org.bluepowerrobotics.bpfox.perf.StartupTimeline
import org.bluepowerrobotics.bpfox.perf.StartupTypeTelemetry
import org.bluepowerrobotics.bpfox.privacyreport.PRIVACY_REPORT_NOTIFICATION_CHANNEL_ID
import org.bluepowerrobotics.bpfox.privacyreport.PrivacyReportNotificationWorker
import org.bluepowerrobotics.bpfox.privacyreport.ensurePrivacyReportNotificationChannelExists
import org.bluepowerrobotics.bpfox.session.PrivateNotificationService
import org.bluepowerrobotics.bpfox.settings.SupportUtils
import org.bluepowerrobotics.bpfox.shortcut.NewTabShortcutIntentProcessor.Companion.ACTION_OPEN_PRIVATE_TAB
import org.bluepowerrobotics.bpfox.splashscreen.ApplyExperimentsOperation
import org.bluepowerrobotics.bpfox.splashscreen.DefaultExperimentsOperationStorage
import org.bluepowerrobotics.bpfox.splashscreen.DefaultSplashScreenStorage
import org.bluepowerrobotics.bpfox.splashscreen.FetchExperimentsOperation
import org.bluepowerrobotics.bpfox.splashscreen.SplashScreenManager
import org.bluepowerrobotics.bpfox.splashscreen.SplashScreenOperation
import org.bluepowerrobotics.bpfox.tabhistory.TabHistoryDialogFragment
import org.bluepowerrobotics.bpfox.theme.DefaultThemeManager
import org.bluepowerrobotics.bpfox.theme.StatusBarColorManager
import org.bluepowerrobotics.bpfox.theme.TabStripStatusBarView
import org.bluepowerrobotics.bpfox.theme.ThemeManager
import org.bluepowerrobotics.bpfox.translations.TranslationsAIControllableFeatureRegistrar
import org.bluepowerrobotics.bpfox.translations.TranslationsEnabledSettings
import org.bluepowerrobotics.bpfox.utils.AccessibilityUtils.announcePrivateModeForAccessibility
