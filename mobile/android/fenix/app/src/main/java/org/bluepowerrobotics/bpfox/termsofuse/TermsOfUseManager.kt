...
package org.bluepowerrobotics.bpfox.termsofuse

import androidx.annotation.VisibleForTesting
import org.bluepowerrobotics.bpfox.termsofuse.store.TermsOfUsePromptRepository
...
class TermsOfUseManager(
    ...
    /**
     * Called from the [org.bluepowerrobotics.bpfox.HomeActivity]'s onStart. Used to track the first check since starting the app.
     */
    fun onStart() {
