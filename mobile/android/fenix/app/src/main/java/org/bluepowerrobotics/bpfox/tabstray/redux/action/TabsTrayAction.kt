...
package org.bluepowerrobotics.bpfox.tabstray.redux.action
...
sealed interface TabsTrayAction : Action {
    ...
    /**
     * Updates the [org.bluepowerrobotics.bpfox.tabstray.redux.state.TabsTrayState.inactiveTabsExpanded] boolean
     *
     * @property expanded The updated boolean to
     *   [org.bluepowerrobotics.bpfox.tabstray.redux.state.TabsTrayState.inactiveTabsExpanded]
     */
    data class UpdateInactiveExpanded(val expanded: Boolean) : TabsTrayAction

    /** Updates the list of synced tabs in [org.bluepowerrobotics.bpfox.tabstray.redux.state.TabsTrayState.syncedTabs]. */
